...
4. "note" must be 2–4 sentences a recruiter can act on. For SURFACE/EVASIVE: LEAD with the gap (what a strong answer would have included), then quote the thin phrase. Do NOT open with praise like "procedurally correct" or "appropriately deferential." For OWNED: cite the decisive owned move.
