...
function mock(p: {
  ...
  return {
    ...
    answersRead: { label: p.answers === "strong" ? "Good answers" : p.answers === "weak" ? "Weak answers" : p.answers === "none" ? "—" : "OK answers", level: p.answers },
